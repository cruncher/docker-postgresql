...
```bash
docker pull cruncher/postgresql:9.6-2-wale
```
...
docker run --name postgresql -itd --restart always \
  ...
  cruncher/postgresql:9.6-2-wale
```
...
```bash
docker run --name postgresql -itd --restart always \
  cruncher/postgresql:9.6-2-wale -c log_connections=on
```
...
```bash
docker run --name postgresql -itd --restart always \
  cruncher/postgresql:9.6-2-wale -c logging_collector=on
```
